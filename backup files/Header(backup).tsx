    ...
    return (
        ...
        <div className={`container-fluid ${OptionalStyle}`}>
            <header className="d-flex flex-wrap align-items-center justify-content-between py-3 mb-4 border-bottom">
                <div className="nav col-12 col-md-2 mb-2 d-flex justify-content-center align-items-center mb-md-0">
                    <a href="/" className="d-inline-flex align-items-center link-body-emphasis text-decoration-none">
                        <img className="img-fluid" src="/shoppingbag.png" alt="" />
                        <div>DD SHOP</div>
                    </a>
                    {/* hamburger menu */}
                    <div id="hamburger-menu" className="d-block d-md-none col-6 text-end" ref={menuRef}>
                      <button
                      className=""
                ...
                {/* 中間選單 只在md以下顯示 */}
                <ul className="nav d-none d-md-flex col-12 col-md-8 mb-2 d-flex flex-nowrap justify-content-center mb-md-0">
                ...
                <div className="d-none d-md-flex col-12 col-md-2 text-center text-md-end d-flex justify-content-center align-items-center">
                  {userInfo?.name && (<div id="user_name" className="text-nowrap fw-bold">Hi, {userInfo.name}</div>)}
                    ...
                    <div id="header-total-items" className="d-flex justify-content-center align-items-center"><span>{totalQuantity}</span></div>
                      ...
                      {isLoggedIn ?
                          <button type="button" className="btn-custom" onClick={() => logout()}>
                            Logout
                          </button>
                        :
